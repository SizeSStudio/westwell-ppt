...
```python
stages = [
    {"title": "卖车 / 卖项目",    "tag": "执行层",       "progress": 100, "state": "已建立"},
    {"title": "争调度 + 标准层", "tag": "中期制高点",   "progress": 40,  "state": "建设中"},
    {"title": "进入运营层",       "tag": "长期方向",     "progress": 10,  "state": "早期探索"},
    {"title": "按结果收费",       "tag": "北极星",       "progress": 0,   "state": "待布局"},
]
```
